...
namespace ProjectClasses
{
    class DBMediatorEmployee : DBMediator
    {
        ...
        //Automatic Schedule
        public Dictionary<Employee,Shift> GetEmployeesAvailabilityPerDepartmentAndWeekNumber(Department department,int week)
        {
            ...
            Dictionary<Employee,Shift> employeeAndAvailability = new Dictionary<Employee, Shift>();
            try
            {
                MySqlDataReader EmployeeReader;
                DbConnection.Open();
                ...
                while (EmployeeReader.Read())
                {
                    ...
                    employeeAndAvailability.Add(emp, availableShift);
                }
                return employeeAndAvailability;
            }
            catch (MySqlException)
            {
                return null;

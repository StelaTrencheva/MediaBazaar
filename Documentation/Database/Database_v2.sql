...
(50, 'Smartwares', 'Smoke detectors', 'RM149', 'reliable', 'Electricity', 'Security', '13.00', '17.99', 20, 50),
(51, 'Flamingo', 'Smoke detectors', 'FA25', 'includes batteries', 'Electricity', 'Security', '5.35', '7.49', 12, 67),
(52, 'Schneider', 'Switch', 'Splash-proof Series', 'resistant to wind and weather', 'Electricity', 'Outdoor electricity', '11.00', '15.99', 13, 78),
(53, 'KlikAanKlikUit', 'Switch', 'Switch AGST-8800', 'The switch has an automatic switch-off function', 'Electricity', 'Outdoor electricity', '14.99', '17.99', 9, 36),
(54, 'GAMMA', 'Lock bolt', 'Lock bolt M8 x 120 mm', 'These lock bolts are made of galvanized steel', 'Hardware', 'Bolts', '3.00', '5.19', 28, 50),
(55, 'Languages Tools', 'Metal wire', 'Bindingfix', 'The diameter of the wire is 1.2 mm and the length is 50 meters', 'Hardware', 'Iron wire', '2.80', '5.09', 8, 20),
(56, 'Dörner & Helmer', 'Metal wire', 'Steel wire 2/3 mm', 'Steel wire is robust', 'Hardware', 'Iron wire', '0.50', '1.39', 18, 79),
(57, 'GAMMA', 'Varnish', 'Wall varnish', 'Transparent', 'Paint', 'Wall paint', '20.00', '24.39', 13, 46),
(58, 'Flexa', 'Wall paint', 'Powerdek latex', 'high covering quality', 'Paint', 'Wall paint', '30.00', '37.89', 10, 26);
...
--
ALTER TABLE `mb_product`
  MODIFY `pNum` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
